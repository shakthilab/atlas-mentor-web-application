...
@Component({
  ...
  template: `
    <div class="dialog-container p-24">
      ...
      <div *ngIf="!loading && fullLead">
        <div class="profile-header d-flex align-items-center m-b-24">
          <img [src]="fullLead.avatar || '/assets/images/profile/user-1.jpg'" class="rounded-circle m-r-16 object-cover avatar-animated" width="64" height="64" />
          <div>
            <h3 class="mat-subtitle-1 f-w-600 m-b-4 f-s-18">{{ fullLead.fullName || fullLead.name || leadData.name }}</h3>
            <span class="f-s-14 text-muted d-block">{{ fullLead.courseName || fullLead.major || 'N/A' }}</span>
            <span class="status-badge m-t-8" [ngClass]="(fullLead.status || 'pending').toLowerCase()">
              {{ getStatusDisplayName(fullLead.status) }}
            </span>
          </div>
        </div>
        ...
        <mat-tab-group class="custom-tab-group">
            ...
            <div class="details-grid p-t-16">
              ...
              <div class="detail-item">
                ...
                <span class="detail-value d-flex align-items-center">
                  ...
                  {{ fullLead.countryName || fullLead.country || 'N/A' }}
                </span>
              </div>
              ...
              <div class="detail-item">
                ...
                <span class="detail-value d-flex align-items-center">
                  ...
                  {{ fullLead.universityName || fullLead.university || 'N/A' }}
                </span>
              </div>
              ...
              <div class="detail-item">
                ...
                <span class="detail-value d-flex align-items-center">
                  <img *ngIf="fullLead.counsellorAvatar" [src]="fullLead.counsellorAvatar" class="rounded-circle m-r-8 object-cover" width="20" height="20" />
                  <i-tabler *ngIf="!fullLead.counsellorAvatar" name="user" class="icon-16 m-r-8 text-muted"></i-tabler>
                  {{ fullLead.assignedByName || fullLead.counsellor || 'Unassigned' }}
                </span>
              </div>
              ...
              <div class="detail-item">
                ...
                <span class="detail-value d-flex align-items-center">
                  ...
                  <span>{{ fullLead.createdByName || fullLead.addedBy || 'System' }}</span>
                </span>
              </div>

              <div class="detail-item" *ngIf="fullLead.createdAt || leadData.leadDate">
                <span class="detail-label">Joined Date</span>
                <span class="detail-value d-flex align-items-center">
                  <i-tabler name="calendar" class="icon-16 m-r-8 text-muted"></i-tabler>
                  {{ (fullLead.createdAt || leadData.leadDate) | date:'mediumDate' }}
                </span>
              </div>
          ...
          <mat-tab label="Academic">
            <div class="academic-history-container p-t-16">
              <div *ngIf="!fullLead.academicHistory || fullLead.academicHistory.length === 0" class="text-center p-24">
              ...
              <div *ngFor="let acad of fullLead.academicHistory" class="academic-record-card border rounded p-16 m-b-16 bg-white">
          ...
          <mat-tab label="Documents">
            <div class="documents-tab-container p-t-16">
              <div *ngIf="!fullLead.documents || fullLead.documents.length === 0" class="text-center p-24">
              ...
              <div class="row">
                <div class="col-12 m-b-12" *ngFor="let doc of fullLead.documents">
...
export class LeadDetailsDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    const leadId = this.leadData.id;
    if (leadId) {
      this.http.get<any>(`${environment.apiUrl}/students/${leadId}`).subscribe({
        next: (res) => {
          this.fullLead = res.data || res;
          this.loading = false;
        },
        error: (err) => {
          console.error('Failed to load lead details:', err);
          this.loading = false;
          this.fullLead = this.leadData;
        }
      });
    } else {
      this.fullLead = this.leadData;
