...
@Component({
  ...
  `,
  styles: [`
    .dialog-container { width: 100%; max-width: 680px; box-sizing: border-box; }
    ...
    .p-x-24 { padding: 0 24px; @media (max-width: 480px) { padding: 0 16px; } }
    .p-t-8 { padding-top: 8px; } .p-t-24 { padding-top: 24px; } .p-b-16 { padding-bottom: 16px; } .p-b-24 { padding-bottom: 24px; }
    .gap-8 { gap: 8px; } .gap-12 { gap: 12px; } .text-primary { color: var(--brand-primary) !important; }
