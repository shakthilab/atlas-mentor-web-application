  ...
  styles: [`
    ...
    :host-context(.dark-theme) {
      ...
      .view-mode-toggle {
        ...
        .toggle-btn { color: #94a3b8; &.active { background-color: var(--brand-primary); color: #ffffff; } &:hover:not(.active) { background-color: var(--dark-hoverbgcolor); } }
      }
      .status-badge {
      ...
      .company-avatar { background: rgba(var(--brand-primary-rgb), 0.2); }
    }
  `]
})
