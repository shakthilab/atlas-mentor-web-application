...
export const navItems: NavItem[] = [
  ...
  // ── MANAGER ────────────────────────────────────────────────────────────────
  { navCap: 'nav.managerSection', roles: ['MANAGER'] },
  { displayName: 'nav.dashboard', iconName: 'layout-dashboard', route: '/manager', roles: ['MANAGER'] },
  { navCap: 'nav.management', roles: ['MANAGER'] },
  { displayName: 'nav.leads', iconName: 'target', route: '/manager/leads', roles: ['MANAGER'] },
  { displayName: 'nav.students', iconName: 'users', route: '/manager/students', roles: ['MANAGER'] },
  { displayName: 'nav.employees', iconName: 'user-check', route: '/manager/employees', roles: ['MANAGER'] },
  { displayName: 'nav.tasks', iconName: 'checklist', route: '/manager/tasks', roles: ['MANAGER'] },
  { displayName: 'nav.referrals', iconName: 'user-plus', route: '/manager/referrals', roles: ['MANAGER'] },
  { displayName: 'nav.companies', iconName: 'briefcase', route: '/manager/companies', roles: ['MANAGER'] },
  { navCap: 'nav.organization', roles: ['MANAGER'] },
  { displayName: 'nav.branches', iconName: 'building', route: '/manager/branches', roles: ['MANAGER'] },
  { displayName: 'nav.hierarchy', iconName: 'sitemap', route: '/manager/hierarchy', roles: ['MANAGER'] },
  { displayName: 'nav.documents', iconName: 'file-text', route: '/manager/documents', roles: ['MANAGER'] },
  { displayName: 'nav.resources', iconName: 'books', route: '/manager/resources', roles: ['MANAGER'] },
  { displayName: 'nav.settings', iconName: 'settings', route: '/manager/settings', roles: ['MANAGER'] },
