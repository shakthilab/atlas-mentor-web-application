...
export const navItems: NavItem[] = [
  ...
  { displayName: 'nav.officeCameras', iconName: 'device-cctv', route: '/admin/office-cameras', roles: ['ADMIN'] },
  ...
  { navCap: 'nav.employeeSection', roles: ['EMPLOYEE', 'SENIOR_COUNSELLOR', 'JUNIOR_COUNSELLOR', 'VIDEO_EDITOR', 'WEB_DEV'] },
  { displayName: 'nav.dashboard', iconName: 'layout-dashboard', route: '/employee', roles: ['EMPLOYEE', 'SENIOR_COUNSELLOR', 'JUNIOR_COUNSELLOR', 'VIDEO_EDITOR', 'WEB_DEV'] },
  { navCap: 'nav.work', roles: ['EMPLOYEE', 'SENIOR_COUNSELLOR', 'JUNIOR_COUNSELLOR', 'VIDEO_EDITOR', 'WEB_DEV'] },
  { displayName: 'nav.leads', iconName: 'target', route: '/employee/leads', roles: ['EMPLOYEE', 'SENIOR_COUNSELLOR', 'JUNIOR_COUNSELLOR', 'VIDEO_EDITOR', 'WEB_DEV'] },
  { displayName: 'nav.students', iconName: 'users', route: '/employee/students', roles: ['EMPLOYEE', 'SENIOR_COUNSELLOR', 'JUNIOR_COUNSELLOR', 'VIDEO_EDITOR', 'WEB_DEV'] },
  ...
  { displayName: 'nav.taskAccountability', iconName: 'checkbox', route: '/manager/task-accountability', roles: ['MANAGER', 'ADMINISTRATIVE_ASSISTANT'] },
  ...
  { displayName: 'nav.officeCameras', iconName: 'device-cctv', route: '/manager/office-cameras', roles: ['MANAGER', 'ADMINISTRATIVE_ASSISTANT'] },
  ...
  { displayName: 'nav.taskAccountability', iconName: 'checkbox', route: '/branch-partner/task-accountability', roles: ['BRANCH_PARTNER'] },
  ...
  { displayName: 'nav.officeCameras', iconName: 'device-cctv', route: '/branch-partner/office-cameras', roles: ['BRANCH_PARTNER'] },
